...
<body>
    ...
    <section class="hero--section" style="background-image: url('./images/hero.png')">
    </section>
    <!-- hero slider section end -->


    <!-- thebest--section start -->
    <section class="thebest--section">
        <div class="custtom-contaner">
            <div class="exp--pro-text">
                <h2 class="heading--h2">The best meat in your city</h2>
                <p>Way too much meat. But if it weren't for the meat, I'd have no identifiable personality whatsoever.</p>
    ...
    <section class="Featured--section mt--100">
        <div class="custtom-contaner">
            ...
            <div class="review--slider">
                <div class="jj">
                    ...
                    <div class="slide sider--box ">
                        <div class="sider-top-txt">BEEF & PORK BOX</div>
                        <div class="feature-slide-img">
                            <img src="images/slide1.png" alt="slide image one">
                        </div>
                    ...
                    <!-- slide 2 -->
                    <div class="slide sider--box ">
                        <div class="sider-top-txt">CUSTOM BOX</div>
                        <div class="feature-slide-img">
                            <img src="images/slisde2.png" alt="slide image two">
                        </div>
                        <div class="slider--btn">
                            <button class="cust--btn">
                                <a class="transiction" href="#">Choose your plan</a>
                    ...
                    <!-- slide 3 -->
                    <div class="slide sider--box ">
                        <div class="sider-top-txt">BEEF, PORK & CHICKEN</div>
                        <div class="feature-slide-img">
                            <img src="images/slide3.png" alt="slide image three">
                        </div>
                        <div class="slider--btn">
                            <button class="cust--btn">
                                <a class="transiction" href="#">Choose your plan</a>
            ...
            <div class="Featured-custombox--section">
                <h2 class="heading--h3">CUSTOM BOX</h2>
    ...
    <section class="howwestart-section mb--100 mt--100">
        <div class="custtom-contaner">
    ...
    <!-- exp--pro--section -->
    <section class="exp--pro--section mb--100 mt--100">
        <div class="exp--pro-wraper">
            <div class="exp--pro-text">
                <h2 class="heading--h2">Explore the product</h2>
                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud</p>
                <button class="cust--btn">
                    <a class="transiction" href="#">Explore</a>
                </button>
            </div>
            <div class="exp--pro-img">
                <img src="images/product.png" alt="peoduct image">
            </div>
        </div>
    </section>
